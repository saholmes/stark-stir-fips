...
// impls.  Derive would require trait bounds the QuadExtConfig trait
// doesn't carry; we serialize the two-element `c` array directly and
// reconstruct via the canonical From<[C::Base; 2]>.
